...
const items = [
  ...
  {
    id: 3,
    color: "from-violet-800 to-purple-400",
  ...
  return (
    ...
    >
      <div className="h-[600vh] relative" ref={ref}>
        <div className="w-screen h-[calc(100vh-6rem)] flex items-center justify-center text-4xl font-bold md:text-8xl text-center">
          My Works
        </div>
      ...
      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center">
        <h1 className="text-4xl md:text-7xl font-bold">Do you have a project?</h1>
